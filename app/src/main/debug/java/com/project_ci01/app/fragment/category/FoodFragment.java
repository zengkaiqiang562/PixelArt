...
public class FoodFragment extends BaseFragment implements OnItemClickListener<HomeImageAdapter.HomeImageHolder> {
    ...
    public void update() {
        ImageDbManager.getInstance().queryByCategory(Category.FOOD.catName, entities -> {
