 ...
 */
public class MyNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    public void setTitleTextSpace(int titleTextSpace) {
        this.titleTextSpace = titleTextSpace;
    }
}
