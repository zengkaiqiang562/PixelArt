...
import com.project_m1142.app.base.utils.JsonUtils;
...
//        LogUtils.e(TAG, "--> getMaxLaunchTime() launchTime(s)=" + launchTime);
    ...
    public boolean checkLimit() {
        String countryCode = LocationManager.INSTANCE.getCountryCode();
        return "CN".equalsIgnoreCase(countryCode) || "IR".equalsIgnoreCase(countryCode);
    }
